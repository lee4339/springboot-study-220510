...
/*
 * Aspect: 여러 핵심 기능에 적용될 관심사 모듈을 의미한다. Aspect에는 구체적인 기능을 구현하는 Advice와 Advice가 어디(Target)에서 
 * 			적용될지 결정하는 PointCut을 포함하고 있다.
 * 
 * Target: 고통 기능을 부여할 대상. 즉, 핵심 기능을 담당하는 비즈니스 로직이고, 어떤 관심사들과도 관계를 맺지 않는다.
 * 
...
public class ValidationAdvice {
	...
	public Object apiAdvice(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
		...
		return proceedingJoinPoint.proceed(); // 필터의 체인역활
	}
}
